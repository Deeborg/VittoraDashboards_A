...
import PromotionAnalyticsDashboard from "./components/Dashboards/commercial/Promotionanalyticsdashboard";
    ...
    <Router>
      <ResponsiveSidebar>
        <Routes>
         ...
         <Route path="/analytics/promotion-analytics" element={<PromotionAnalyticsDashboard />} />
