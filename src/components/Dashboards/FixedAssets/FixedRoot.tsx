...
const [activeSection, setActiveSection] = React.useState("asset");
  ...
  <div className="fa-dashboard">
    ...
    <div className="fa-sidebar">
      <div
        className={`fa-menu-item ${activeSection === "asset" ? "active" : ""}`}
      ...
      <div
        className={`fa-menu-item ${activeSection === "cwip" ? "active" : ""}`}
      ...
      <div
        className={`fa-menu-item ${activeSection === "depreciation" ? "active" : ""}`}
    ...
    <div className="fa-content">
        ...
        <>
          ...
          <div className="kpi-strip">
            <div className="kpi-card">
              <div className="kpi-card__label">Gross Block</div>
            ...
            <div className="kpi-card">
              <div className="kpi-card__label">Net Block</div>
              <div className="kpi-card__value">
            ...
            <div className="kpi-card">
              ...
              <div className="kpi-card__value">{totalAssets}</div>
            </div>
          </div>
        ...
        <>
          ...
          <div className="kpi-strip">
            <div className="kpi-card">
              ...
              <div className="kpi-card__value">{totalCWIP}</div>
            </div>

            <div className="kpi-card">
              <div className="kpi-card__label">Total Amount Spent</div>
              <div className="kpi-card__value">
      ...
      {activeSection === "depreciation" && (
        <>
          ...
          <div className="kpi-strip">
            <div className="kpi-card">
              <div className="kpi-card__label">Reconciliation Items</div>
              <div className="kpi-card__value">
                {totalReconciliation}
              </div>
            </div>
