...
const InvestmentsDashboard = () => {
  ...
  const avgYield = investmentsData.reduce((sum, inv) => sum + inv.yield, 0) / investmentsData.length;
  ...
  return (
    <Card>
      <CardContent>
                ...
                <TableRow key={investment.id}>
                  ...
                  <TableCell align="right">
                    ...
                    <Typography variant="caption" sx={{ color: '#90a4ae' }}>
                      {((investment.amount / totalInvestments) * 100).toFixed(1)}% of portfolio
                    </Typography>
                  </TableCell>
                  <TableCell align="right">
                    <Chip
                      ...
                      size="small"
                      sx={{
                        backgroundColor: investment.yield > 7.5 ? '#e8f5e9' : '#e3f2fd',
                        color: investment.yield > 7.5 ? '#2e7d32' : '#1565c0',
                        fontWeight: 500,
                      }}
                    />
                  </TableCell>
                  <TableCell align="right">{investment.maturity}</TableCell>
                  <TableCell>
                    <Chip
                  ...
                  <TableCell>
                    <Chip
                      ...
                      size="small"
                      sx={{
                        backgroundColor: getRatingColor(investment.creditRating) + '20',
                        color: getRatingColor(investment.creditRating),
                        fontWeight: 600,
                      }}
                    />
                  </TableCell>
        ...
        <Box sx={{ mt: 2 }}>
          <Typography variant="body2" sx={{ color: '#546e7a' }}>
            <strong>Portfolio Composition:</strong> Liquid (39.2%) • Debt (18.3%) • ICD (29.3%) • Government (13.2%) | 
            <strong> Next Maturity:</strong> Treasury Bill (Jun 2024) | 
            <strong> Credit Quality:</strong> 100% Investment Grade
          </Typography>
        </Box>
      </CardContent>
    </Card>
