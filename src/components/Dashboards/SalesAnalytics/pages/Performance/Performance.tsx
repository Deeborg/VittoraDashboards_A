...
const Performance: React.FC = () => {
  ...
  return (
    // 👇 Ensure the parent ID is present so all scoped styles apply
    <div id="sales-dashboard-isolated">
      <div className="performance">
        ...
        <div className="kpi-cards">
          <div className="kpi-card">
            ...
            <div className="kpi-content">
              ...
              <div className="kpi-value">
                ₹8.2M <span className="kpi-change positive">+12%</span>
              </div>
          ...
          <div className="kpi-card">
            ...
            <div className="kpi-content">
              <h3>Growth Rate</h3>
              <div className="kpi-value">
                24.5% <span className="kpi-change positive">+4.2%</span>
              </div>
              <div className="kpi-progress">
          ...
          <div className="kpi-card">
            ...
            <div className="kpi-content">
              ...
              <div className="kpi-value">
                4.8 <span className="kpi-change positive">+0.3</span>
              </div>
              <div className="kpi-progress">
        ...
        <div className="performance-charts">
          {/* Optional: uncomment to show revenue chart */}
          ...
          <div className="chart-container">
            <ChartCard
              ...
              type="bar"
              // 👇 Use a simpler data shape (name + value) for better compatibility
